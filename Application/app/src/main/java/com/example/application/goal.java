class goal{
    ...
    private String excercise; //TODO: need to implement with excercise class/object (make it a selection off of muscle group)
    ...
    public void setMilestone(int stone){lastMilestone = stone;}
    //TODO: set frequency as a list

    public String getType(){return type;}
    public String getGroup(){return group;}
    public int getGoal(){return max;}
    public int getMilestone(){return lastMilestone;}
